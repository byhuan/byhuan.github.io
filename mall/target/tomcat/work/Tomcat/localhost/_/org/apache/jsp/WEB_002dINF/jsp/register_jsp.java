 ...
 * Generated at: 2019-04-01 07:42:41 UTC
...
public final class register_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script type=\"text/javascript\" src=\"/js/allMail.js\"></script>\r\n");
      ...
      out.write("/index\"><img src=\"/images/logo.png\" border=\"0\" /><span>欢迎注册</span></a>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("<!-- reg_main -->\r\n");
      ...
      out.write("            \t<input id=\"regName\" name=\"username\"  class=\"regInput\" type=\"text\" onkeyup=\"mail_div(event);\" onfocus=\"showtip('regName','userMamErr',8);\" onblur=\"$('#userMamErr').html('')\" autocomplete=\"off\" maxlength=\"80\"/>\r\n");
      out.write("\t\t\t\t<em></em>\r\n");
      out.write("            </span>\r\n");
      ...
      out.write("                <font style=\"font-size:12px;\">安全程度：</font><em class=\"default\" id=\"low\">弱</em><em class=\"default\" id=\"middle\">中</em><em class=\"default\" id=\"strong\">强</em>\r\n");
      out.write("            </li>\r\n");
      out.write("\r\n");
      out.write("            <li class=\"regMb30\">\r\n");
      ...
      out.write("            </li>\r\n");
      out.write("            \r\n");
      out.write("            <li style=\"margin-left:329px\">\r\n");
      out.write("                <a href=\"javascript:void(0)\" onclick=\"sendcode()\">发送验证码</a>\r\n");
      out.write("            </li>\r\n");
      out.write(" \r\n");
      out.write("            <li>\r\n");
      out.write("                <label><font>*</font> 验证码：</label>\r\n");
      out.write("                <span class=\"regM defaultBorder\">\r\n");
      out.write("            \t\t<input id=\"code\" name=\"code\" type=\"text\" autocomplete=\"off\" class=\"regInput\" maxlength=\"11\" onfocus=\"showtip('code','codeErr',4);\"/>\r\n");
      out.write("           \t\t\t<em></em>\r\n");
      out.write("           \t\t</span>\r\n");
      out.write("           \t\t<span class=\"regInput\" id=\"codeErr\"></span>\r\n");
      out.write("            </li>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t<a href=\"#\" target=\"_blank\"  class=\"checkTitle\">我已阅读并同意<font style=\"font-size:12px;\">《自营商城用户注册协议》</font></a>\r\n");
      out.write("\t\t\t</span>\r\n");
      ...
      out.write("        </form>\r\n");
      out.write("    </ul>\r\n");
      out.write("    <div class=\"ui-reg-tip\"><a href=\"#\" target=\"_blank\">了解更多>></a></div>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<!--mainOver-->\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t</span>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t河南理工大学<br> <a href=\"http://www.hpu.cn\" target=\"_blank\" rel=\"nofollow\" class=\"footerlink1\">京ICP备12011349号</a>|<a href=\"http://www.e3mall.cn/www/174/461.html\" target=\"_blank\" rel=\"nofollow\" class=\"footerlink1\"></a><br> Copyright© 理工大商城\r\n");
      out.write("\t\t\t liu版权所有<br>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<!-- /footer -->\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t//检查手机号是否已经存在\r\n");
      out.write("\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\turl : REGISTER.param.surl + \"/user/check/\"+$(\"#phone\").val()+\"/2?r=\" + Math.random(),\r\n");
      out.write("            \tsuccess : function(data) {\r\n");
      out.write("            \t\tif (data.data) {\r\n");
      out.write("            \t\t\t//如果手机号没有被占用，发送验证码\r\n");
      out.write("            \t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\t\turl : REGISTER.param.surl + \"/user/sendcode/\"+$(\"#phone\").val(),\r\n");
      out.write("            \t\t\t\tsuccess : function(data) {\r\n");
      ...
      out.write("\t\t\t  var str = $(\"#pwd\").val();\r\n");
      out.write("\t        \tif(str.length < 8){\r\n");
      out.write("\t        \t\tif(str.length == 0){\r\n");
      out.write("\t        \t\t\t$(\"#low\").css(\"color\",\"white\");\r\n");
      out.write("\t\t        \t\t$(\"#middle\").css(\"color\",\"white\");\r\n");
      out.write("\t\t        \t\t$(\"#strong\").css(\"color\",\"white\");\r\n");
      out.write("\t        \t\t}\r\n");
      out.write("\t        \t\t$(\"#low\").css(\"color\",\"red\");\r\n");
      out.write("\t        \t\t$(\"#middle\").css(\"color\",\"white\");\r\n");
      out.write("\t        \t\t$(\"#strong\").css(\"color\",\"white\");\r\n");
      out.write("\t        \t}else if(str.length < 14){\r\n");
      out.write("\t        \t\t$(\"#low\").css(\"color\",\"white\");\r\n");
      out.write("\t        \t\t$(\"#middle\").css(\"color\",\"red\");\r\n");
      out.write("\t        \t\t$(\"#strong\").css(\"color\",\"white\");\r\n");
      out.write("\t        \t}else{\r\n");
      out.write("\t        \t\t$(\"#low\").css(\"color\",\"white\");\r\n");
      out.write("\t        \t\t$(\"#middle\").css(\"color\",\"white\");\r\n");
      out.write("\t        \t\t$(\"#strong\").css(\"color\",\"red\");\r\n");
      out.write("\t        \t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("</script>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      ...
      out.write("\t\t\t\tshowError(\"code\",\"codeErr\",codeArr[1]);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t//密码检查\r\n");
      ...
      out.write("\t            \tsuccess : function(data) {\r\n");
      out.write("\t            \t\tif (data.data) {\r\n");
      out.write("\t            \t\t\t//发送验证码时已经检查过手机号是否存在\r\n");
      out.write("\t            \t\t\t//这里需要的是比对验证码是否正确\r\n");
      out.write("\t            \t\t\t$.ajax({\r\n");
      out.write("\t            \t\t\t\turl : REGISTER.param.surl + \"/user/checkcode/\"+$(\"#code\").val()+\"/\"+$(\"#phone\").val(),\r\n");
      out.write("\t\t\t\t            \tsuccess : function(data) {\r\n");
      out.write("\t\t\t\t            \t\tif (data.status == 200) {\r\n");
      out.write("\t\t\t\t\t            \t\tREGISTER.doSubmit();\r\n");
      out.write("\t\t\t\t            \t\t} else if(data.status == 500){\r\n");
      out.write("\t\t\t\t            \t\t\tshowError(\"code\",\"codeErr\",mcodeArr[1]);\r\n");
      out.write("\t\t\t\t            \t\t}else if(data.status == 400){\r\n");
      out.write("\t\t\t\t            \t\t\tshowError(\"code\",\"codeErr\",dmArr[0]);\r\n");
      out.write("\t\t\t\t            \t\t}\r\n");
      out.write("\t\t\t\t            \t}\r\n");
      out.write("\t            \t\t\t});\r\n");
      out.write("\t            \t\t} else {\r\n");
