    ...
    <div class="p-list">
      <ul class="list-all">
         ...
         <li>
            <div class="l-wrap">
				<div class="pic">
					<a class="trackref" href="http://localhost:8888/item/${item.id}.html" target="_blank">
						<img src="${item.image }" style="display:inline"/>
					</a>
				</div>
	            <div class="price">
					<span class="p-now">￥<strong>${item.price }</strong><span class="active" style="">直降</span></span>			
				</div>
	            <div class="title-a">
	                <a href="http://localhost:8888/item/${item.id}.html" target="_blank">${item.title }</a>
	            </div>
	            <!--  
	        	<div class="title-b" style=""><a class="trackref" href="http://localhost:8888/item/${item.id}.html" target="_blank">${item.sell_point }</a></div>
	            -->
