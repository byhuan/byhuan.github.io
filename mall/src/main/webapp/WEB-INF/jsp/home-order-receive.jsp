                ...
                <div class="yui3-u-1-6 list">
                    ...
                    <div class="list-items">
                        <dl>
							...
							<dd><a href="http://localhost:8888/order/home-order-receive" class="list-active">待收货</a></dd>
						</dl>
                    </div>
                </div>
                <!--右侧主内容-->
                    ...
                    <div class="body">
                        ...
                        <div class="order-detail">
                            <div class="orders">
                                ...
                                <c:forEach items="${orderPageGet }" var="order">
                                    		 <table>
                                   			 <tbody>
                                    		...
                                    		<tr>
	                                            ...
	                                            <c:if test="${status.index == 0 }">
		                                            ...
		                                            <td width="10%" class="center" rowspan="${fn:length(order.itemList)}">
		                                                <ul class="unstyled">
		                                                    <li><a href="http://localhost:8888/order/sureGet/${item.orderId }" class="sui-btn btn-info">确认收货</a></li>
		                                                </ul>
		                                            </td>
	                                            </c:if>
	                                        </tr>
